...
public class CustomerOnlyExport extends AbstractPOIExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		List<Map <String,Object>> list = (List<Map <String,Object>>) model.get("customerList");
		...
		sheet.setColumnWidth(colCount++, 30*256);	// 4 D
		...
		columnList.add("กิจกรรมที่เข้าร่วม");		// column 4
		...
		firstCell.setCellValue("รายชื่อผู้สมัครเข้าร่วมกิจกรรม ปี " + fiscalYear);
